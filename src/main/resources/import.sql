insert into user (id, admin, email, name, password, enabled) values ('1', false, 'joao@gmail.com', 'João', '$2a$10$C3tNZaAUdh2qJFQYVZ5yTeis5UGO.33F6Z5ewcQBve9YyTlS9AOXO', true);
insert into user (id, admin, email, name, password, enabled) values ('2', true, 'maria@gmail.com', 'Maria', '$2a$10$C3tNZaAUdh2qJFQYVZ5yTeis5UGO.33F6Z5ewcQBve9YyTlS9AOXO', true);
insert into user (id, admin, email, name, password, enabled) values ('3', false, 'romulo@gmail.com', 'Rômul', '$2a$10$C3tNZaAUdh2qJFQYVZ5yTeis5UGO.33F6Z5ewcQBve9YyTlS9AOXO', true);
